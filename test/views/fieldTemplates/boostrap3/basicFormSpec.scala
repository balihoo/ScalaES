package views.fieldTemplates.boostrap3
...
import views.html.fieldTemplates.bootstrap3._
...
class basicFormSpec extends Specification with Mockito {
  ...
  "basicForm" should {
    ...
    "have has-error class and error p element when errors present" in {
      ...
      val content = contentAsString(basicForm(mockFieldElements))
